...
component displayname="CFML DogAPI"  {
  ...
  variables._cfmldogapi_version = '1.0.2';
  ...
  * @hint Display a single random image from all dogs collection
  */
  public struct function getRandomImage() {
    return apiCall( 'GET', '/breeds/image/random' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/random
  * @hint Returns multiple random images from all dogs collection
  */
  public struct function listRandomImages( numeric count = 1 ) {
    return apiCall( 'GET', '/breeds/image/random/#count#' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/#all
  * @hint Lists all available breeds (and sub-breeds)
  */
  ...
  * @hint Lists all the images from a breed, e.g. hound
  */
  public struct function listImagesByBreed( required string breed ) {
    return apiCall( 'GET', '/breed/#breed#/images' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/breed
  * @hint Returns a random dog image from a breed, e.g. hound
  */
  public struct function getRandomImageByBreed( required string breed ) {
    return apiCall( 'GET', '/breed/#breed#/images/random' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/breed
  * @hint Returns multiple random dog images from a breed, e.g. hound
  */
  public struct function listRandomImagesByBreed( required string breed, numeric count = 1 ) {
    return apiCall( 'GET', '/breed/#breed#/images/random/#count#' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/sub-breed
  * @hint Lists all the sub-breeds from a breed
  */
  public struct function listSubBreedsByBreed( required string breed ) {
    return apiCall( 'GET', '/breed/#breed#/list' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/sub-breed
  * @hint Returns a single random image from a sub breed
  */
  public struct function getRandomImageBySubBreed( required string breed, required string subbreed ) {
    return apiCall( 'GET', '/breed/#breed#/#subbreed#/images/random' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/sub-breed
  * @hint Return multiple random dog images from a sub-breed, e.g. Afghan Hound
  */
  public struct function listRandomImagesBySubBreed( required string breed, required string subbreed, numeric count = 1 ) {
    return apiCall( 'GET', '/breed/#breed#/#subbreed#/images/random/#count#' );
  }

  /**
  * https://dog.ceo/dog-api/documentation/sub-breed
  * @hint Lists all the images from the sub-breed, e.g. Boston Bulldog
  */
  public struct function listImagesBySubBreed( required string breed, required string subbreed ) {
    return apiCall( 'GET', '/breed/#breed#/#subbreed#/images' );
  }
  ...
  private struct function getBaseHttpHeaders() {
    return {
      ...
      'User-Agent' : 'CFML DogAPI/#variables._cfmldogapi_version# (ColdFusion)'
    };
  }
